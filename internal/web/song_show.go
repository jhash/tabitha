...
func SongShowHandler(q *db.Queries) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		page := Page(song.Title, description, nil, songShowContent(song, blocks, hasVersion))
...
func songShowContent(song db.Song, blocks []transcription.Block, hasVersion bool) g.Node {
	return Div(
